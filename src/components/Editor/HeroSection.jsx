...
const HeroSection = ({ projectsRef }) => {
  ...
  return (
    <div className='relative sm:px-[18vw] px-[5vw] py-12 leading-tight'>
      <motion.h2
        className='font-[Beycago] text-blu mb-[-12vw]text-[6vw] md:text-[4vw] relative z-30'
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <motion.h3
        className='font-[Andenver] text-[5vw] md:text-[3vw] mt-[-12vw] text-blu relative leading-tight z-30'
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 0.5, ease: 'easeIn' }}
      >
